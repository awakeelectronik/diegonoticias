...
> Blog de noticias minimalista con editor propio. Sitio estático Hugo + admin Vue, todo en un binario Go.
...
- **Editor manual**: título, cuerpo (Markdown), imagen con su alt, categoría y meta description. Si la meta se deja vacía se deriva del primer párrafo.
...
Go 1.25 · Hugo extended · Vue 3.5 + Vite + Pinia + Tailwind v4 · libvips (govips) · Argon2id.
